...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-360%20passed-2ea44f?logo=pytest" alt="Tests">
...
| **辩论引擎** | LangGraph StateGraph 四节点：数据收集 → 多大师分析 → **第二轮交叉审阅+反驳** → 加权投票聚合 | ✅ MVP + D1 |
...
- **360 测试全绿** — 单元测试 + 模块测试 + 辩论交叉审阅 + 真实 LLM 集成测试
...
Phase 1 ──── MVP 链路 ██████████████████░░░  65% 🟡
  │  data/ ✅  debate/ ✅（D1 交叉审阅）memory/ ✅  待完成：端到端接驳 · Agent 接入记忆 · 前端
...
- 🧪 **360 测试** — 含真实 LLM 集成测试 + 辩论交叉审阅，不是 mock 到死
