...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-300%20passed-2ea44f?logo=pytest" alt="Tests">
  ...
  <img src="https://img.shields.io/badge/architecture%20decisions-10%20ADRs-informational" alt="ADRs">
</p>
...
- **300+ 测试全绿** — 单元测试 + 模块测试 + 真实 LLM 集成测试
...
- **10 份架构决策记录（ADR）** — 每条技术选型均有理由、权衡和替代方案
...
Phase 1 ──── MVP 链路 ██████░░░░░░░░░░░░░░  35% 🟡
  │  data/ ✅  debate/ ✅  待完成：端到端接驳 · 前端 · 记忆系统 · 风险控制
...
- 📐 **10 份架构决策记录** — 每步选型有理由有权衡，不是"跟着教程写"
- 🧪 **300+ 测试** — 含真实 LLM 集成测试，不是 mock 到死
