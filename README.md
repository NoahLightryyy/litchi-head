...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-950%20passed-2ea44f?logo=pytest" alt="Tests">
...
- **950 测试全绿** — 单元测试 + 模块测试 + 辩论全流程（9层链路） + 回测桥接 + 真实 LLM 集成测试
...
- 🧪 **950 测试** — 含真实 LLM 集成测试 + 10 层完整链路（含用户经验反馈闭环🆕），不是 mock 到死
