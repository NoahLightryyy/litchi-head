...
| **多源证据完整性** | 六态来源结果 + 独立上游计数 + K 线逐源准确响应证明 + 不可变 `as_of` 回放 + LLM 前失败关闭 | 🟡 K 线 KR-1B、KR-2A 与 KR-2B-1 新浪累计因子快照已完成；官方公司行动核验、统一信封及 AI/API 切换待完成 |
...
Phase R ──── 实盘加固 █████████████████████████░░  88% 🟡 ← 当前阶段
  ...
  │  多源契约 ✅ · K线 KR-2B-1 ✅/KR-2B-2～6 🟡 · 置信度功能 ✅/真实校准待积累 · baseline/影子验证 ⬜
