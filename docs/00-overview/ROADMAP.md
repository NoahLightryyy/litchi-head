...
```
总 Python 测试数 │ 1600 passed / 4 skipped / 19 slow deselected（1623 collected）
技术债务         │ 71 条总记 / 39 条已关闭 / 32 条开放
...
| 🟡 P0 | **TD-069 / KR-2 公司行动与统一复权** — 2C 转换核心与深市三事件实网已完成；下一原子 TD-075 沪市日期版式兼容、修订回放和故障烟测 | KR-1B ✅；[实施计划](../02-requirements/KLINE_EVIDENCE_IMPLEMENTATION_PLAN.md) KR-2 | ~0.25d |
