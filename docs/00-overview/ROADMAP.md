...
| 🟡 P0 | **TD-069 / KR-2 公司行动与统一复权** — 2B2B 已完成官方模板、双现金口径与修订公告联网归链；下一原子 2C 匹配相邻累计除数并生成已核验因子 | KR-1B ✅；[实施计划](../02-requirements/KLINE_EVIDENCE_IMPLEMENTATION_PLAN.md) KR-2 | ~0.5d |
