...
```
总 Python 测试数 │ 1342 passed / 4 skipped / 19 slow deselected（1365 collected）
...
| 🔥 P0 | **TD-069 / KR-1B-2C-2～3 状态账本与持久化** — CNINFO 官方 PDF 停复牌事件采集已完成并通过 300996 烟测；待连续事件账本、上市退市生命周期、北交所官方适配、长窗覆盖和 RAW/诊断回放 | KR-1B-2C-1 | ~0.5–1d |
