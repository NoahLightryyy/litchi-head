...
department: 数据管道部
codebase: src/data/
last_updated: 2026-07-30 (KR-1B-1 官方市场日历门禁完成)
---
...
| 9 🔥 | K 线 KR-1B-2～3 停牌/生命周期与持久化 | 官方全天停牌、上市退市边界、长窗与回放 |
| 10 🔥 | K 线 KR-2 统一复权 | RAW/公司行动/派生序列分层；点时因子 |
| 11 🔥 | K 线 KR-3 四层证据信封 | `FINAL_DAILY` 与今日 `PROVISIONAL` 严格分层 |
| 12 🔥 | 行业证据迁移到统一门禁 | K 线门禁完成后 |
...
4. 下一步为 KR-1B-2 RED：官方全天停牌、盘中临停、上市前和退市后日期契约；
5. 随后 KR-1B-3 证明长窗截断、RAW/诊断持久化和回放；
