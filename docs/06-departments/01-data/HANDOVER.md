...
department: 数据管道部
codebase: src/data/
last_updated: 2026-08-03 (KR-2B-2C 转换核心完成，沪市验收待 TD-075)
---
...
| 17 🔥 | K 线 KR-2 统一复权 | 下一原子：RAW/公司行动/派生序列分层；点时因子 |
...
- 🟡 沪市 `600000/688008` 实网日期表格版式漂移登记 TD-075；完成兼容、修订回放
  和故障烟测前，不能宣称整个 KR-2 完成或切入 AI。
...
13. 下一原子是 TD-075：以原始官方 PDF 夹具扩展 SSE 日期表格布局，并完成沪市
   普通/差异化、修订回放和来源故障烟测；不得猜测日期或绕过失败关闭；
14. KR-2 通过后按 KR-3 输出 `FINAL_DAILY / FINAL_MINUTE / LIVE_QUOTE /
