...
department: 数据管道部
codebase: src/data/
last_updated: 2026-07-30 (KR-1B-2C-1 官方停复牌事件采集完成)
---
...
| 12 🔥 | K 线 KR-1B-2C-2～3 状态账本与持久化 | 连续覆盖、生命周期、北交所、长窗与回放 |
| 13 🔥 | K 线 KR-2 统一复权 | RAW/公司行动/派生序列分层；点时因子 |
| 14 🔥 | K 线 KR-3 四层证据信封 | `FINAL_DAILY` 与今日 `PROVISIONAL` 严格分层 |
| 15 🔥 | 行业证据迁移到统一门禁 | K 线门禁完成后 |
...
4. KR-1B-2A/B/2C-1 已完成，不得重复状态契约、运行时门禁或 CNINFO PDF 解析；
5. 下一步为 KR-1B-2C-2：建立连续事件账本、合并重复公告，并补生命周期与北交所
   官方适配；事件层不得直接冒充完整状态窗口；
6. 随后 KR-1B-3 证明长窗截断、RAW/诊断持久化和回放；
