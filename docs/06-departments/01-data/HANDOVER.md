...
department: 数据管道部
codebase: src/data/
last_updated: 2026-08-04 (TD-075 关闭，KR-2 完成)
---
...
| 18 🔥 | K 线 KR-3 四层证据信封 | KR-3A、KR-3B-1 成功组装 ✅；下一步 KR-3B-2 失败诊断归并 |
...
13. TD-075 已关闭且 KR-2 已通过；不得重复 SSE 重复表、修订版、空白标题归链或
   差异化扣减回购股本规则；
14. KR-3A 与 KR-3B-1 已完成，不得另建四层模型、另写晋升状态机或绕开现有成功
   组装器；下一原子 KR-3B-2 只归并四层失败诊断，再交给辩论、后端等下游；
