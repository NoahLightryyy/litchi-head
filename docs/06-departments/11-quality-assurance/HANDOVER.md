...
| 🔥 | **TD-069/KR-6 K 线全链路验收** — 来源独立性、RAW、复权、点时、四层状态、零 LLM、交易价格、API/UI 和故障注入 | KR-2A 26 项与 KR-2B-1 13 项契约已覆盖纯算法和累计快照，沪深/BSE 真实烟测通过；下一步验收 KR-2B-2 官方事件匹配。后续 KR-3～6 复用黑盒快照/回放接口，不重复白盒实现 |
