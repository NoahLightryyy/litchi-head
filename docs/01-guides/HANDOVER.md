...
11. 下一原子功能是 KR-1B：用经过批准的交易日历与个股停牌状态生成预期完成交易
    ...
    先让用户确认，不能用工作日猜测停牌；
12. KR-1B 来源调研已完成：推荐把三家交易所年度休市公告做成本地版本化权威日历，
    新浪仅作差异告警；缺日只在交易所/上市公司官方公告证明全天停牌时排除。东方
    财富历史日期过滤实测漂移，不能参与成功判定；Tushare 当前无包、无令牌且 BSE
    覆盖未验证。当前停在用户确认免费官方方案或账户/持牌方案的决策点；
13. KR-1B 通过后才按 KR-2～KR-6 推进统一复权、四层信封、AI/风控/交易、
