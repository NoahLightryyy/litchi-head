...
>
> 归属部门：[🔄 质量保障部](../../06-departments/11-quality-assurance/ROLE.md)
...
| [ISSUES.md](ISSUES.md) | 质量保障部 | CI 问题追踪日志（类似债务，专用） |
| [HANDBOOK.md](HANDBOOK.md) | 质量保障部 | CI 维护手册（改 workflow、加检查项） |
...
> 修 CI 同样遵循「代码 + 测试 + 文档 + 债务日志 + 引用清理」五同步：
> - 修复 CI 的代码改动
...
| [质量保障部 HANDOVER.md](../../06-departments/11-quality-assurance/HANDOVER.md) | 质量保障 |
