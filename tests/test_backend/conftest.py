...
def make_board_perf_df(
    ...
    if rows is None:
        rows = [
            {"板块代码": "BK001", "板块名称": "银行", "涨跌幅": 1.5, "主力净流入-净额": 500_000_000.0},
            {"板块代码": "BK002", "板块名称": "券商", "涨跌幅": -0.5, "主力净流入-净额": -200_000_000.0},
        ]
...
def make_board_stocks_df(
    ...
    if rows is None:
        rows = [
            {"代码": "000001", "名称": "平安银行", "现价": 12.5, "涨跌幅": 2.0, "主力净流入": 1_000_000.0},
            {"代码": "000002", "名称": "招商银行", "现价": 35.0, "涨跌幅": 1.5, "主力净流入": 2_000_000.0},
            {"代码": "000003", "名称": "工商银行", "现价": 5.8, "涨跌幅": 0.5, "主力净流入": 500_000.0},
            {"代码": "000004", "名称": "建设银行", "现价": 7.2, "涨跌幅": -0.3, "主力净流入": -100_000.0},
            {"代码": "000005", "名称": "中国银行", "现价": 4.5, "涨跌幅": 0.2, "主力净流入": 300_000.0},
            {"代码": "000006", "名称": "农业银行", "现价": 3.8, "涨跌幅": -0.5, "主力净流入": -200_000.0},
        ]
    return pd.DataFrame(rows)
